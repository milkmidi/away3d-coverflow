...
set AND_CERT_FILE=cert\milkmidi.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=E:\BackUpmedialandWork\[Medialand]\p12\tw.medialand.pc.p12
set IOS_DEV_CERT_FILE=E:\BackUpmedialandWork\[Medialand]\p12\tw.medialand.pc.p12
set IOS_PROVISION=E:\BackUpmedialandWork\[Medialand]\p12\milkmidi_test.mobileprovision
...
set APP_ID=com.milkmidi.stage3ddemo.coverflow

:: Output packages
set DIST_PATH=dist
set DIST_NAME=away3d_coverflow
